...
const CONTACT_EMAIL = 'aw.js.share@gmail.com';
      ...
      <div className={styles.content}>
        ...
        <section className={styles.section}>
          ...
          <ul className={styles.list}>
            ...
            <li>
              <strong>반려동물 정보</strong>: 이름, 종(개/고양이), 품종, 생년월일, 성별, 체중,
              중성화 여부, 프로필 이미지
            </li>
            <li>
            ...
            <li>
              <strong>진료 정보</strong>: 방문 병원명, 방문일, 진료 내용, 첨부 이미지(진단서·사진
              등)
            </li>
            <li>
              <strong>투약·접종·예약 정보</strong>: 약품명, 용법·용량, 투약 기간, 접종명, 접종일,
              다음 접종 예정일, 병원 예약 일시 및 메모
            </li>
            <li>
              <strong>AI 건강 리포트 생성 정보</strong>: 리포트 생성을 요청하면 위 건강 기록 정보가
              AI 분석을 위해 이용됩니다. 자세한 내용은 6항을 참고해 주세요.
            </li>
            <li>
        ...
        <section className={styles.section}>
          ...
          <p className={styles.paragraph}>
            회사는 원칙적으로 회원 탈퇴 시 지체 없이 개인정보를 파기합니다. 다만 서비스 오남용 방지
            및 이용자 보호를 위해 다음과 같이 유예 기간을 둡니다.
          </p>
          <ul className={styles.list}>
            <li>
        ...
        <section className={styles.section}>
          ...
          <p className={styles.paragraph}>
            ...
            형태의 정보는 복구할 수 없는 방법으로 영구 삭제하며, 종이 문서는 별도로 존재하지
            않습니다.
          </p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <p className={styles.paragraph}>
            ...
            있거나 수사기관이 법령에서 정한 절차와 방법에 따라 요청하는 경우는 예외로 합니다.
          </p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <ul className={styles.list}>
            ...
            <li>
              이용자는 앱 내 &apos;설정 &gt; 회원 탈퇴&apos;를 통해 개인정보 처리 정지 및
              삭제(탈퇴)를 요청할 수 있습니다.
            </li>
            <li>
